...
(function () {
  ...
  var KEY = "cvShortlistGuideState";

  // EDIT THIS: user-facing UI strings. Translate per guide language (e.g. Hebrew).
  var T = {
    percentDone: function (p) { return p + "% הושלם"; },
    copied: "הועתק ✓",
    copyOk: "הועתק ללוח",
    copyFail: "ההעתקה נכשלה, סמנו והעתיקו ידנית",
    reset: "ההתקדמות אופסה",
    finished: "כל השלבים הושלמו 🎉"
  };
